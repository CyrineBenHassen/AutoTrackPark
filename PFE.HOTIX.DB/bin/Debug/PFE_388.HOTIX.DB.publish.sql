...
BEGIN
	...
	INSERT INTO
		dbo.[reservation] (datedebutreservation,datefinresevation,id_etat_demande,description_reservation , user_id ,matricule_voiture)
					
	VALUES 
		((SELECT ISNULL(MAX(id_etat_demande),0) FROM reservation) + 1,GETDATE(),GETDATE(), @id_etat_demande ,@user_id ,@matricule_voiture)
