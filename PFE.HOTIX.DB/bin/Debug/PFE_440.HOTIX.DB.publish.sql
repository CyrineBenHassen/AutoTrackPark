...
END
GO
PRINT N'Création de Procédure [dbo].[sp_localisation_get_all_by_mat]...';
...
BEGIN
	...
	FROM
		...
		INNER JOIN dbo.[def_parc] dp ON dp.id_parc = v.id_parc AND ((@parc_id = -1) OR (@parc_id = dp.id_parc))
...
BEGIN
	...
	VALUES 
		                       (1, N'Administrateur', N'ADMIN', N'1w7USZx2lywZENk8S0Cv8g==', N'admin@mail.com', N'00 00000000', 1, '19700101', GETDATE())
END
