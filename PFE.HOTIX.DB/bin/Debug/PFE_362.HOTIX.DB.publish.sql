...
--BEGIN
--	INSERT INTO dbo.[maintenance]([Description_Maintenance],[Lieu_Maintenance],[Date_Maintenance],[id_type_maintenance],[matricule_voiture]) 
--	VALUES 
--		('Controle Generale', 'Tunis', GETDATE(), 1,'122TN1424')		
--END
