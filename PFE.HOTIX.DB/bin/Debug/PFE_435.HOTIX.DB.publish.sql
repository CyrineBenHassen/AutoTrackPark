...
GO
ALTER TABLE [dbo].[maintenance] ALTER COLUMN [Date_Maintenance] DATETIME NULL;


GO
PRINT N'Actualisation de Procédure [dbo].[sp_maintenance_delete]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_maintenance_delete]';


GO
PRINT N'Actualisation de Procédure [dbo].[sp_maintenance_get_all]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_maintenance_get_all]';


GO
PRINT N'Actualisation de Procédure [dbo].[sp_maintenance_get_one_by_id]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_maintenance_get_one_by_id]';


GO
PRINT N'Actualisation de Procédure [dbo].[sp_maintenance_insert]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_maintenance_insert]';


GO
PRINT N'Actualisation de Procédure [dbo].[sp_maintenance_update]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[sp_maintenance_update]';
