...
GO
PRINT N'Création de Table [dbo].[app_demande_reservation]...';


GO
CREATE TABLE [dbo].[app_demande_reservation] (
    [demande_reservation_id]        INT          IDENTITY (1, 1) NOT NULL,
    [demande_reservation_datedebut] DATETIME     NULL,
    [demande_reservation_datefin]   DATETIME     NULL,
    [description_demande]           NCHAR (1000) NULL,
    [user_id]                       INT          NULL,
    [id_reservation]                INT          NULL,
    PRIMARY KEY CLUSTERED ([demande_reservation_id] ASC)
);
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_appDemandeFormation_To_defUser]...';


GO
ALTER TABLE [dbo].[app_demande_reservation]
    ADD CONSTRAINT [FK_appDemandeFormation_To_defUser] FOREIGN KEY ([user_id]) REFERENCES [dbo].[app_user] ([user_id]);


GO
PRINT N'Création de Clé étrangère [dbo].[FK_appDemandeFormation_To_reservation]...';


GO
ALTER TABLE [dbo].[app_demande_reservation]
    ADD CONSTRAINT [FK_appDemandeFormation_To_reservation] FOREIGN KEY ([id_reservation]) REFERENCES [dbo].[reservation] ([id_reservation]);
...
BEGIN
	...
	INSERT INTO
		dbo.[app_demande_reservation] 
		(user_id, demande_reservation_datedebut, demande_reservation_datefin, description_demande) 
	VALUES 
		(@userId, @demande_reservation_datedebut, @demande_reservation_date_fin, @description_demande)
