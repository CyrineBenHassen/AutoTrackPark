...
CREATE TABLE [dbo].[app_user] (
    ...
    [user_first_name]    VARCHAR (1) NOT NULL,
    [user_last_name]     VARCHAR (1) NULL,
    [user_login]         VARCHAR (1) NOT NULL,
    [user_password]      NCHAR (250) NOT NULL,
    [user_email]         VARCHAR (1) NULL,
...
CREATE TABLE [dbo].[def_etat] (
    ...
    [etat_code] VARCHAR (1) NULL,
    [etat_name] VARCHAR (1) NULL,
...
CREATE TABLE [dbo].[def_parc] (
    ...
    [nom_parc]     VARCHAR (1) NULL,
    [tel_parc]     INT         NULL,
    [adresse_parc] VARCHAR (1) NULL,
    [email_parc]   VARCHAR (1) NULL,
...
CREATE TABLE [dbo].[localisation] (
    ...
    [Temps_Localisation]     VARCHAR (1)      NULL,
...
CREATE TABLE [dbo].[maintenance] (
    ...
    [Type_Maintenance]        VARCHAR (1) NULL,
    [Description_Maintenance] VARCHAR (1) NULL,
    [Lieu_Maintenance]        VARCHAR (1) NULL,
