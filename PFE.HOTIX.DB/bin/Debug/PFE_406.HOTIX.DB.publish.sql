...
BEGIN
	...
	INSERT INTO
		dbo.[reservation] (id_reservation,datedebutreservation,datefinresevation,description_reservation, user_id )
					
	VALUES 
		((SELECT ISNULL(MAX(id_etat_demande),0) FROM reservation) + 1,GETDATE(),GETDATE(), @description_reservation ,@user_id )
