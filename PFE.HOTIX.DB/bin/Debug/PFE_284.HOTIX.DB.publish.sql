...
GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé c151db3a-e16e-45b2-bc1d-fd82ce9be3f6 est ignorée, l''élément [dbo].[maintenance].[Id_maintenance] (SqlSimpleColumn) ne sera pas renommé en id_maintenance';
...
BEGIN
	...
	SELECT 
		...
		ISNULL(Lieu_Maintenance, 0) AS Lieu_maintenance ,
...
BEGIN
	...
	INSERT INTO
		dbo.[maintenance] (Description_Maintenance, Date_Maintenance,Lieu_Maintenance, matricule_voiture,id_type_maintenance )
					
	VALUES 
		(@Description_Maintenance,  GETDATE(), @Lieu_Maintenance, @matricule_voiture, @id_type_maintenance )
