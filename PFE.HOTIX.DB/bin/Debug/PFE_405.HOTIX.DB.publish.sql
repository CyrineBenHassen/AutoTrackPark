...
BEGIN
	...
	INSERT INTO
		dbo.[reservation] (id_reservation,datedebutreservation,datefinresevation,id_etat_demande,description_reservation, user_id )
					
	VALUES 
		((SELECT ISNULL(MAX(id_etat_demande),0) FROM reservation) + 1,GETDATE(),GETDATE(),1 ,@description_reservation ,@user_id )
...
--BEGIN
--	INSERT INTO dbo.[reservation]([datedebutreservation],[datefinresevation],[description_reservation],[user_id],[matricule_voiture] )
--	VALUES 
--		(GETDATE(),GETDATE(),'syrine',1,1,'123TN4124')
