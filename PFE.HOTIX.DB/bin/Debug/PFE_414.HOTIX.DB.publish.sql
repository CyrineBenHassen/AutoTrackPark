...
CREATE PROCEDURE [dbo].[sp_parc_get_one_by_id]
    ...
    p.id_parc=@id_parc
     ...
     END
GO
PRINT N'Création de Procédure [dbo].[sp_parc_get_one_by_user_id]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[sp_reservation_confirm]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[sp_reservation_refuse]...';
...
END
GO
PRINT N'Création de Procédure [dbo].[sp_type_get_one_by_id]...';
...
BEGIN
	...
	VALUES 
		(1, 'MOUTEUR'),(2, 'VIDANDE'),(1, 'CONTROLE ')
...
--	VALUES 
--		(1, 'ParcTunis','+21622145789' , 'Tunis' , 'parcTunis@gmail.com' , 3),
--		(2, 'ParcGafsa','+21655145787' , 'Gafsa' , 'parcGafsa@gmail.com' , 3),
--		(3, 'ParcBizerte','+21699145389' , 'Bizerte' , 'parcBizerte@gmail.com' , 3),
--		(4, 'ParcKef','+21622145789' , 'Kef' , 'ParcKef@gmail.com' , 3)
...
--	VALUES 
--		('123TN4124','BLACK','4000KM','2019',1,1,1,1,1),
--		('789TN9724','RED','2000KM','2018',4,1,1,1,2),
--		('159TN6524','BLUE','9854KM','2016',3,1,1,2,3),
--		('321TN7424','GRAY','14780KM','2020',2,1,1,1,4),
--		('122TN1424','GREEN','14789KM','2017',1,1,1,1,4)
