    ...
    public class UserController : ControllerBase
    {
        ...
        public ApiResponse UserLogin(LoginModel User)
        {
            try
            {
                ...
                Entities.Reservation curResa = null;
                Entities.Reservations userRes = Repository.Reservation.GetAll(-1, _Data.Id);

                curResa = userRes.FirstOrDefault(r => r.Etat_demande.id_etat_demande == (int)Entities.Enumeration.EtatDemande.CONFIRMER);

                _Data.MatriculeVoiture = (curResa != null) ? curResa.Voiture.matricule_voiture : string.Empty;
