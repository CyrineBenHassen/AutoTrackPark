...
GO
PRINT N'Modification de Procédure [dbo].[sp_maintenance_get_all]...';


GO
ALTER PROCEDURE [dbo].[sp_maintenance_get_all]
...
BEGIN
	...
	WHERE
		((@matricule_voiture = -1) OR (@matricule_voiture = m.matricule_voiture))
