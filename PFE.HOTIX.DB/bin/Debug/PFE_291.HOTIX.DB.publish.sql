...
GO
PRINT N'Modification de Procédure [dbo].[sp_maintenance_insert]...';


GO
ALTER PROCEDURE [dbo].[sp_maintenance_insert] 
    @id_maintenance int ,
...
BEGIN
	...
	INSERT INTO
		dbo.[maintenance] (id_maintenance, Date_Maintenance,Lieu_Maintenance, matricule_voiture,id_type_maintenance )
