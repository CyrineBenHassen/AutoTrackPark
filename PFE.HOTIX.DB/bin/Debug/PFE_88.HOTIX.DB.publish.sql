...
GO
PRINT N'L''opération de refactorisation de changement de nom avec la clé ef314ff8-e76c-4532-a99a-dd7b6e72a7f4 est ignorée, l''élément [dbo].[def_etat_demande].[Id_etat_demande] (SqlSimpleColumn) ne sera pas renommé en id_etat_demande';
...
BEGIN
	...
	VALUES 
		(1, 'parcbizete',22145789 , 'bizerte' , 'parcbizerte@gmail.com' , 1)
