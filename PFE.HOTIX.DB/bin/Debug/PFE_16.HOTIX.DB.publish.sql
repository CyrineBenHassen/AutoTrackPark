...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_voiture_To_def_marque]...';


GO
ALTER TABLE [dbo].[voiture] WITH NOCHECK
    ADD CONSTRAINT [FK_voiture_To_def_marque] FOREIGN KEY ([id_marque]) REFERENCES [dbo].[def_marque] ([Id_marque]);
...
ALTER TABLE [dbo].[voiture] WITH CHECK CHECK CONSTRAINT [FK_voiture_To_def_marque];
