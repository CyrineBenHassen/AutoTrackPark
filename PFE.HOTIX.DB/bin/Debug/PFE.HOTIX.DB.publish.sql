...
GO
PRINT N'Creating Foreign Key [dbo].[FK_User_To_DefUserRole]...';


GO
ALTER TABLE [dbo].[user]
    ADD CONSTRAINT [FK_User_To_DefUserRole] FOREIGN KEY ([role_id]) REFERENCES [dbo].[def_user_role] ([role_id]);
...
BEGIN
	...
	INSERT INTO
		dbo.[user] (role_id, user_first_name, user_last_name, user_login, user_password,
...
BEGIN
	INSERT INTO dbo.[user]([role_id], [user_first_name], [user_last_name], [user_login], [user_password], 
						   [user_email], [user_phone], [user_is_active], [user_birth_date], [user_creation_date]) 
	VALUES 
		(1, N'ADMIN', N'ADMIN', N'ADMIN', N'ADMIN', N'admin@mail.com', N'00 00000000', 1, '19700101', GETDATE())
END
GO
